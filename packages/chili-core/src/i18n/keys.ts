...
const I18N_KEYS = [
    ...
    "popupUSection.length",
    "popupHSection.width",
    "popupHSection.height",
    "popupHSection.flangeThickness",
    "popupHSection.webThickness",
    "popupHSection.length",
    "popupLSection.width",
    "popupLSection.widthTwo",
    "popupLSection.thickness",
    "popupLSection.length",
    "popupTeeSection.width",
    "popupTeeSection.height",
    "popupTeeSection.thickness",
    "popupTeeSection.length",
    "popuptube.outerRadius",
    "popuptube.innerRadius",
    "popuptube.height",
    "popupcylinder.radius",
    "popupcylinder.height",
    "popupbox.width",
    "popupbox.height",
    "popupbox.length",
    "entity.editable",
    ...
    "ribbon.group.templates",
    "ribbon.tab.draw",
    "ribbon.tab.file",
    "ribbon.tab.tools",
    "ribbon.tab.startup",
    "ribbon.tab.templates",
    "snap.center",
    "snap.end",
    "snap.intersection",
    "snap.mid",
